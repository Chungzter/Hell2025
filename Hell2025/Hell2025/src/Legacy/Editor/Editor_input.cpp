        ...
        if (Editor::GetEditorState() == EditorState::GIZMO_TRANSLATING ||
            ...
            if (Input::LeftMouseDown() || Input::RightMouseDown() || Input::MiddleMouseDown()) {
                if (Input::GetMouseX() == 0) {
                    Input::SetCursorPosition(Hell::BackEnd::GetFullScreenWidth() - 2, Input::GetMouseY());
                }
                if (Input::GetMouseX() == Hell::BackEnd::GetFullScreenWidth() - 1) {
                    Input::SetCursorPosition(1, Input::GetMouseY());
                }
                if (Input::GetMouseY() == 0) {
                    Input::SetCursorPosition(Input::GetMouseX(), Hell::BackEnd::GetFullScreenHeight() - 2);
                }
                if (Input::GetMouseY() == Hell::BackEnd::GetFullScreenHeight() - 1) {
