...
namespace EditorUI {
    ...
    void NewFileWindow::CreateImGuiElements() {
        ...
        float windowWidth = (float)Hell::BackEnd::GetCurrentWindowWidth();
        float windowHeight = (float)Hell::BackEnd::GetCurrentWindowHeight();
    ...
    void LeftPanel::BeginImGuiElement() {
        float panelHeight = Hell::BackEnd::GetCurrentWindowWidth() - ImGuiBackEnd::GetFileMenuHeight();
