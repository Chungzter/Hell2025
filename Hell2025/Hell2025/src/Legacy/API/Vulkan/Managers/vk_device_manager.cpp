...
#include "Hell/Backend/Integration/SDL.h"
...
namespace VulkanDeviceManager {
    ...
    bool CreateSurface() {
        return Hell::BackEnd::GLFW::CreateSurface(&g_surface);
    }
    ...
    bool CreateInstance() {
        ...
        std::vector<const char*> extensions = Hell::BackEnd::GLFW::GetRequiredInstanceExtensions();
