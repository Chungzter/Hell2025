...
namespace {
    ...
    bool PrepareHouseGeometry(DDGIRayQueryVolumeGeometryCache& geometry, DDGIVolume& ddgiVolume) {
        ...
        DDGIHouseGeometry houseGeometry = DDGIGeometryBuilder::BuildHouseGeometry(boundsMin, boundsMax);
    ...
    bool PrepareDoorGeometry() {
        ...
        DDGIGeometryBuilder::BuildDoorProxyMesh(vertices, indices);
...
bool BuildDDGIRayQueryScene(VkCommandBuffer commandBuffer, DDGIVolume& ddgiVolume, VulkanDescriptorSet* descriptorSet) {
    ...
    const std::vector<DDGIDoorProxyInstance> doorProxyInstances = DDGIGeometryBuilder::CollectDoorProxyInstances(volumeBoundsMin, volumeBoundsMax);
