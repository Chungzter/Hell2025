...
namespace ParticleManager {
    ...
    void Update(float deltaTime) {
        ...
        if (g_bubbleSpawnCooldownTimer > 0) {
            ...
            if (spawn) {
                ...
                //spawnPos += (cameraForward * 0.4f) + Util::RandomFloat(0.0125f, 0.5f);
                //spawnPos += (cameraRight * Util::RandomFloat(-0.1f, 0.1f));
                //spawnPos -= cameraUp * Util::RandomFloat(0.0f, 0.1f);
        ...
        if (player->CameraIsUnderwater() && yVel < 0.0f) {
            ...
            bool spawn = Util::RandomFloat(0.0f, 1.0f) < spawnChance;
            ...
            if (spawn) {
                ...
                spawnPos -= (cameraRight * Util::RandomFloat(-0.05f, 0.05f));
                SpawnParticle(spawnPos);
            }
        }
    ...
    void SpawnParticle(const glm::vec3& position) {
        ...
        particle.velocity.x = Util::RandomFloat(-0.1, 0.1);
        particle.velocity.y = Util::RandomFloat(0.25, 0.5);
        particle.velocity.z = Util::RandomFloat(-0.1, 0.1);
        particle.rotation = Util::RandomFloat(0, HELL_PI * 2.0f);
        particle.scale = Util::RandomFloat(0.025, 0.075);
