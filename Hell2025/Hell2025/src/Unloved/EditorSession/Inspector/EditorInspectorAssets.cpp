...
namespace Unloved::EditorSession::Inspector {
    ...
    bool HasMaterials() {
        ...
        if (Workspace::GetMode() == EditorSessionMode::MAP && MapTools::GetMode() == MapTools::Mode::HEIGHT_MAP) return true;
    ...
    void RenderMaterials(const EditorRect& rect) {
        ...
        if (Workspace::GetMode() == EditorSessionMode::MAP && MapTools::GetMode() == MapTools::Mode::HEIGHT_MAP) {
