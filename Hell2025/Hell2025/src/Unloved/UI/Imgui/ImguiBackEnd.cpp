...
namespace ImGuiBackEnd {
    ...
    void Init() {
        ...
        GLFWwindow* window = (GLFWwindow*)Hell::BackEnd::GLFW::GetWindowPointer();
    ...
    void Update() {
        ImGuiIO& io = ImGui::GetIO();
        io.DisplaySize = ImVec2((float)Hell::BackEnd::GetCurrentWindowWidth(), (float)Hell::BackEnd::GetCurrentWindowHeight());
